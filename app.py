...
def get_details_by_roll_number(processed_df, timetable_df, roll_number):
    result_df = processed_df[processed_df['Roll No.'].astype(int) == roll_number]
    timetable_result_df = timetable_df[timetable_df['Roll No.'].astype(int) == roll_number]
    return result_df[['Roll No.', 'Core Section', 'Professional Elective 1', 'Professional Elective 2']], timetable_result_df

# Main function
def main():
    # Load and process data
    merged_df, timetable_df = load_data()
    ...
    if query_section == 'Yes':
        ...
        if specific_roll == 'Yes':
            ...
            if st.sidebar.button("Get details"):
                   roll_number_result_df, timetable_result_df = get_details_by_roll_number(processed_df, timetable_df, roll_number)
