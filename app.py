...
elective_file_url = 'https://raw.githubusercontent.com/satyam26en/student-information-system/main/elective%20-%20Sheet1%20(1).csv'
core_file_url = 'https://raw.githubusercontent.com/satyam26en/student-information-system/main/core_section%20-%20Sheet1.csv'
...
def main():
    ...
    st.sidebar.image("kiit_logo.jpg", use_column_width=True)
    ...
    if query_section == 'Yes':
        ...
        if section_result_df.empty:
            st.write("No data available for the selected section.")
        else:
        ...
        if specific_roll == 'Yes':
            ...
            if st.sidebar.button("Get details"):
                ...
                if roll_number_result_df.empty:
                    st.write("No data available for the entered roll number.")
                else:
            ...
            if st.sidebar.button("Get range details"):
                ...
                if range_result_df.empty:
                    st.write("No data available for the entered roll number range.")
                if range_result_df.empty:
                    st.write("No data available for the entered roll number range.")
                else:
