...
elective_file_url = 'https://github.com/satyam26en/student-information-system/blob/main/elective%20-%20Sheet1%20(1).csv'
core_file_url = 'https://github.com/satyam26en/student-information-system/blob/main/core_section%20-%20Sheet1.csv'
...
def main():
    ...
    st.sidebar.image("https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Student_Information_System.svg/1200px-Student_Information_System.svg.png", use_column_width=True)
